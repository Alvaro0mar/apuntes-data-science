...
### Otras funciones útiles para generar arrays
...
Los operadores matemáticos `+`, `-`, `*`, `/`, `%`, `**` se utilizan para realizar suma, resta, producto, cociente, resto y potencia a nivel de elemento.
